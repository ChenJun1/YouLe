...
public class PresenterForgetPassWord extends MyBasePresenter<IUForgetPassWord, ActivityForgetPassWord> {
    ...
    public PresenterForgetPassWord(IUForgetPassWord view, ActivityForgetPassWord activity) {
        super(view, activity);
    }
    ...
    public void requestUpdatePass() {
        ...
        new HttpRxObservable().getObservable(ApiUtlis.getUserApi().forgetPwd(request), getActivity(), ActivityEvent.STOP).subscribe(httpRxObserver);
