...
public class EaseChatFragment extends EaseBaseFragment implements EMMessageListener {
    ...
    protected void initView() {
         ...
         * 头部问诊说明
         */
        mTitleText = (TextView) getView().findViewById(R.id.pop_title_tv);
        mContenText = (TextView) getView().findViewById(R.id.pop_content_tv);
        LinearLayout linearLayout = getView().findViewById(R.id.pop_ll);
        String title = fragmentArgs.getString(EaseConstant.EXTRA_DESCRIPIONTITLE);
        String conten = fragmentArgs.getString(EaseConstant.EXTRA_DESCRIPIONCONTENT);
        if (title != null && conten != null && !title.isEmpty() && !conten.isEmpty()) {
            mTitleText.setText(title);
            mContenText.setText(conten);
        } else {
