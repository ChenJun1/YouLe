...
public class ExceptionEngine {
    ...
    public static final int X0 = 0;        //成功
    public static final int X1 = 1;  //失败
    public static final int X1001 = -1001;    //手机号不能为空
    public static final int X1002 = -1002;    //手机号格式不正确
    public static final int X1003 = -1003;    //密码不能为空
    public static final int X1004 = -1004;    //用户不存在
    public static final int X1005 = -1005;    //密码不正确
    public static final int X1006 = -1006;    //code只能为数字
    public static final int X1007 = -1007;    //Token不正确
    public static final int X1008 = -1008;    //登录失效，重新登陆
    public static final int X1009 = -1009;    //手机号已注册
    public static final int X1010 = -1010;    //发送验证码频繁，请稍后重试
    public static final int X1011 = -1011;    //验证码失效
    public static final int X1012 = -1012;    //验证码不正确
